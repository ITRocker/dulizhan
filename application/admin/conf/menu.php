...
if (1 == tpCache('global.web_weapp_switch') && file_exists(ROOT_PATH.'weapp')) {
    //功能限制
    $auth_function = true;
...
if (1 == tpCache('global.web_users_switch')) {
    $users_index_arr = array(
        'is_menu' => 1,
        'is_modules' => 1,
    );
...
if (1 == tpCache('global.web_users_switch') && 1 == getUsersConfigData('shop.shop_open') && 1.5 <= tpCache($shopServicemeal)) {
    $shop_index_arr = array(
        'is_menu' => 0,
        'is_modules' => 1,
    );
...
if (1 == tpCache('global.web_users_switch') && 1 == getUsersConfigData('users.users_open_release')) {
    $archives_index_draft_arr = array(
        'is_menu' => 1,
        'is_modules' => 1,
    );
...
if (is_dir('./weapp/Diyminipro/') && 1 == tpCache('global.web_diyminipro_switch')) {
    $diyminipro_index_arr = array(
        'is_modules' => 1,
    );
}
