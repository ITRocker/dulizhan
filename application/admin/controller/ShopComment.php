...
class ShopComment extends Base
{
    ...
    public function comment_index()
    {
        ...
        // 评价查询
        $field = 'a.comment_id, a.order_id, a.users_id, a.order_code, a.product_id, a.details_id, a.content, a.admin_reply, a.total_score, a.is_visitors, a.visitors_email, a.visitors_name, a.is_new_comment, a.is_show, a.add_time, a.lang, b.product_name, b.product_price, b.litpic as product_img, b.num as product_num, c.username, c.nickname, c.email, c.head_pic, d.title, d.users_price, d.litpic';
        $Comment = Db::name('shop_order_comment')->alias('a')->where($condition)
            ...
            ->join('__ARCHIVES__ d', 'a.product_id = d.aid', 'LEFT')
        ...
        foreach ($Comment as &$value) {
            ...
            // 商品链接
            $value['arcurl'] = get_arcurl($New[$value['product_id']], true, '', $value['lang']);
    ...
    public function comment_details()
    {
        ...
        if (!empty($comment_id)) {
            // 退换货信息
            $field = 'a.comment_id, a.order_id, a.users_id, a.order_code, a.product_id, a.upload_img, a.admin_reply, a.content, a.total_score, a.is_show, a.add_time, b.product_name, b.product_price, b.litpic as product_img, b.num as product_num, c.username, c.nickname, c.email, c.head_pic, d.title, d.users_price, d.litpic';
