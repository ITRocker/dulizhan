...
class Channeltype extends Base
{
    ...
    public function _initialize() {
        parent::_initialize();
        $zan = new Zan('');
        $this->channeltype_system_nid = array_merge($this->channeltype_system_nid, array_keys($zan->getTags()));
...
<section class="article-list">
                    {zan:list pagesize="10" titlelen="38"}
                    <article>
                ...
                <section class="list-pager">
                    {zan:pagelist listitem='index,pre,pageno,next,end' listsize='2' /}
                    <div class="clear"></div>
                </section>
EOF;
...
<section class="article-list">
                    ...
                    <article>
                        ...
                        <div class="meta">
                            <span class="item"><time>{\$field.add_time|MyDate='Y-m-d',###}</time></span>
                            <span class="item">{\$field.typename}</span>
                            {zan:arcview aid='\$field.aid' id='view'}
                                  {zan:volist name="\$view.file_list" id='vo'}
                                ...
                                <div class="pic">
                                    <div class="wrap">
                                        {zan:volist name="\$zan.field.image_list"}
                                            <img src="{\$field.image_url}" alt="{\$zan.field.title}" />
                                        {/zan:volist}
                                    </div>
                                </div> 
                            </fieldset>
...
<div class="md_block">
                            <fieldset>
                                <legend>下载地址：</legend>
                                 {zan:volist name="\$zan.field.file_list" id="field"}
...
<div class="md_block">
                            <p>
                                {zan:videoplay aid='\$zan.field.aid' autoplay='on' id='video'}
                                ...
                                {zan:videolist aid='\$zan.field.aid' id='video'}
                                ...
                                课件：<a href="{\$zan.field.courseware}" target="_blank">{\$zan.field.courseware}</a><br/>
                                
                                <hr/>

                                {zan:memberinfos mid='\$zan.field.users_id' id="users"}
