...
class Index extends Base
{
    ...
    public function index()
    {
        ...
        else if (!isset($_GET['clear']) && 2 == $seo_pseudo && !empty($this->zan['global']['seo_showmod']) && !empty($this->zan['global']['seo_html_position'])) {
        ...
        if (file_exists('./weapp/Recruits/model/RecruitsModel.php')) {
            ...
            $recruitsViewfile = $recruitsModel->setHome($this->zan);
