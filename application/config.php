...
$service_ey = 'aHR0cDovL3NlcnZpY2UuemFucy41ZmEuY24=';
$service_ey_token = '2d49d094106b6b78f28ec1948aea0f60';
$service_ey2 = 'aHR0cDovL3NlcnZpY2UuemFuLjVmYS5jbg==';
if (file_exists("./data/conf/https_service.txt")) {
    $service_ey = 'aHR0cHM6Ly9zZXJ2aWNlLnphbnMuNWZhLmNu';
    $service_ey_token = 'fb71b6752ccafb09d4cfa3dacbef3892';
    $service_ey2 = 'aHR0cHM6Ly9zZXJ2aWNlLnphbi41ZmEuY24=';
}
...
return array(
    ...
    'HTML_CACHE_ARR'    => [
        ...
        'home_Article_alls'     => ['filename'=>'alls', 'p'=>array('page','channel'), 'cache'=>7200],
        ...
        'home_Product_alls'     => ['filename'=>'alls', 'p'=>array('page','channel'), 'cache'=>7200],
        ...
        'home_Images_alls'      => ['filename'=>'alls', 'p'=>array('page','channel'), 'cache'=>7200],
        ...
        'home_Download_alls'    => ['filename'=>'alls', 'p'=>array('page','channel'), 'cache'=>7200],
        ...
        'home_Media_alls'     => ['filename'=>'alls', 'p'=>array('page','channel'), 'cache'=>7200],
        ...
        'home_Special_alls'      => ['filename'=>'alls', 'p'=>array('page','channel'), 'cache'=>7200],
        ...
        'home_Single_alls'     => ['filename'=>'alls', 'p'=>array('page','channel'), 'cache'=>7200],
        'home_Single_lists'    => ['filename'=>'lists', 'p'=>array('page','tid'), 'cache'=>7200],
        'home_Single_view'     => ['filename'=>'view', 'p'=>array('dirname','page','aid'), 'cache'=>7200],
        // [超短伪静态]全部列表页
        'home_Lists_alls'       => ['filename'=>'alls', 'p'=>array('page','channel'), 'cache'=>7200],
        // [超短伪静态]列表页
