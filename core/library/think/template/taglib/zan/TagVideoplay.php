...
EOF;
                ...
                $buy_url = ROOT_DIR . "/index.php?m=user&c=Media&a=media_order_buy&lang={$this->lang}";
                $record_process_url = ROOT_DIR . "/index.php?m=home&c=Media&a=record_process&lang={$this->lang}";
                $result['hidden'] = <<<EOF
