    ...
    public function getUi()
    {
        ...
        if ("on" == $this->uiset) {
            ...
            if ($v == 'mobile' && 1 == $iframe) {
                $parseStr .= "<link rel='stylesheet' type='text/css' href='".get_absolute_url("{$this->root_dir}/public/static/common/css/zan_m.css?v={$version}")."' />";
                $parseStr .= "<script language='javascript' type='text/javascript' src='".get_absolute_url("{$this->root_dir}/public/static/common/js/zan_m.js?v={$version}")."'></script>";
            } else {
                $parseStr .= "<link href='".get_absolute_url("{$this->root_dir}/public/static/common/css/zan.css?v={$version}")."' rel='stylesheet' media='screen' type='text/css' />";
                $parseStr .= "<script language='javascript' type='text/javascript' src='".get_absolute_url("{$this->root_dir}/public/static/common/js/zan.js?v={$version}")."'></script>";
            }
        }
