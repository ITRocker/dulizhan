...
class Page{
       ...
       // config('VAR_PAGE') && $this->p = config('VAR_PAGE'); //设置分页参数名称
        ...
        if (isMobile()) {
            $this->config = [
                ...
                'prev'   => ('admin' == MODULE_NAME) ? '上一页' : lang('sys2'),
                'next'   => ('admin' == MODULE_NAME) ? '下一页' : lang('sys3'),
                'first'  => ('admin' == MODULE_NAME) ? '首页' : lang('sys1'),
                'last'   => ('admin' == MODULE_NAME) ? '末页' : lang('sys4'),
    ...
    public function show() {
        ...
        $this->config['last'] = ('admin' == MODULE_NAME) ? '末页' : lang('sys4');
        //上一页
