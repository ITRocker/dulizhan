...
function btn_upgrade(obj, type)
{
    ...
    if (filelist_arr.length > 50) {
        ...
        filelist_arr.push("……");
        filelist_arr.push("<a href='https://www.zancms.com/plus/upgrade.php?version="+curent_version+"-"+version+"' target='_blank'>此次更新涉及的全部文件，点击这里查看！</a>");
...
{
    var msg1 = '非授权站点不支持在线升级，有需要可以购买商业授权，如有不便请多包涵！';
    if (__allow_service_os__ && __allow_service_os__.msg1) {
        msg1 = __allow_service_os__.msg1;
    }
    var msg = '<style type="text/css">.layui-layer-content{text-align:left!important;}</style>'+msg1;
    parent.layer.alert(msg, {
        shade: layer_shade,
        area: ['480px', '230px'],
        move: false,
