...
function ShopDelAddress(addr_id) {
    ...
    if (1 === parseInt(jsonData.is_wap)) {
        showConfirmBox(ey_langpack_users222, null, function() {
            showLayerLoad();
            $.ajax({
        ...
        unifiedConfirmBox(ey_langpack_users222, showWidth, showHeight, function() {
            $.ajax({
                url : jsonData.shop_del_address,
                data: {addr_id: addr_id},
                type: 'post',
...
function SetDefault(obj, addr_id) {
    ...
    if (1 === parseInt(jsonData.is_wap)) {
        ...
        showConfirmBox(ey_langpack_users223, null, function() {
            showLayerLoad();
            $.ajax({
        ...
        unifiedConfirmBox(ey_langpack_users223, showWidth, showHeight, function() {
