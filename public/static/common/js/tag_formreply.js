function get_formreply_list(obj) {
    ...
    var ajaxdata = 'lang='+lang+'&typeid='+typeid+'&page='+page+'&pagesize='+pagesize+'&ordermode='+ordermode+'&totalpage='+totalpage+'&_ajax=1';

    //步骤一:创建异步对象
    var ajax = new XMLHttpRequest();
    //步骤二:设置请求的url参数,参数一是请求的类型,参数二是请求的url,可以带参数,动态的传递参数starName到服务端
    ajax.open("post", root_dir_v379494+"/index.php?m=api&c=Ajax&a=get_formreply_list&lang="+__lang__, true);
    // 给头部添加ajax信息
