...
function mobile_fleshVerify(){
    var src =  __root_dir__+'/index.php?m=api&c=Ajax&a=vertify&type=users_mobile_reg&lang='+__lang__;
    if (src.indexOf('?') > -1) {
        src += '&';
    } else {
        src += '?';
...
function checkMobileUser1649732103() {
    ...
    layer_loading('正在处理');
    $.ajax({
        url:  __root_dir__+'/index.php?m=user&c=Users&a=mobile_reg&lang='+__lang__,
