...
function CancelOrder(order_id) {
    if (1 === parseInt(jsonData.is_wap)) {
        showConfirmBox(ey_langpack_users280, null, function() {
            $.ajax({
        ...
        unifiedConfirmBox(ey_langpack_users280, showWidth, showHeight, function() {
            $.ajax({
                url : jsonData.shop_order_cancel,
                data: {order_id: order_id},
                type: 'post',
...
function OrderRemind(order_id, order_code) {
    if (1 === parseInt(jsonData.is_wap)) {
        showConfirmBox(ey_langpack_users281, null, function() {
            $.ajax({
        ...
        unifiedConfirmBox(ey_langpack_users281, showWidth, showHeight, function() {
            $.ajax({
                url : jsonData.shop_order_remind,
                data: {order_id: order_id, order_code: order_code},
                type: 'post',
...
function Confirm(order_id, order_code) {
    if (1 === parseInt(jsonData.is_wap)) {
        showConfirmBox(ey_langpack_users282, null, function() {
            $.ajax({
        ...
        unifiedConfirmBox(ey_langpack_users282, showWidth, showHeight, function() {
            $.ajax({
                url : jsonData.shop_member_confirm,
                data: {order_id: order_id, order_code: order_code},
                type: 'post',
