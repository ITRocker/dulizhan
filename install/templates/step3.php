        ...
        <div class="server">
          <table width="100%" id="table" border="0" cellspacing="1" cellpadding="4">
            ...
            <tr>
              ...
              <td><input type="text" name="dbname" id="dbname" value="zancms" class="input" autocomplete="off" onBlur="TestDbPwd(0)"><div id="J_install_tip_dbname"></div></td>
            </tr>
            <tr>
              <td class="tar">数据库表前缀</td>
              <td><input type="text" name="dbprefix" id="dbprefix" value="zan_" class="input" autocomplete="off"><div id="J_install_tip_dbprefix"><span class="gray">推荐使用&nbsp;zan_</span></div></td>
            </tr>
          </table>
